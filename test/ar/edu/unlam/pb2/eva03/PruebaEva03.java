...
public class PruebaEva03 {
	...
	public void  queUnCorredorNoSePuedaInscribirEnUnaCarreraDeNatacion () throws NoEstaPreparado, NoExiste{	
	...
	@Test (expected = NoEstaPreparado.class)
	public void  queUnCorredorNoSePuedaInscribirEnUnTriatlon () throws NoEstaPreparado, NoExiste{		
	...
	@Test
	public void  queUnCorredorPuedaCorrerUnaMaraton() throws NoEstaPreparado, NoExiste{		
	...
	@Test
	public void queBuscaDeportista() throws NoExiste{
		Deportista celeste = new Corredor(999, "Celeste", 42000);
		Club actual = new Club("Moron");
		actual.agregarDeportista(celeste);
		assertEquals(celeste, actual.buscarDeportista(celeste));
		
	}
	@Test (expected = NoExiste.class)
	public void queBuscarDeportistaYNoLoEncuentra() throws  NoExiste, NoEstaPreparado{
		Club actual = new Club("Moron");
		Deportista celeste = new Corredor(999, "Celeste", 42000);
		actual.crearEvento(TipoDeEvento.CARRERA_42K, "Maraton de New York");
		assertEquals((Integer)1, actual.inscribirEnEvento("Maraton de New York", celeste));	
	...
	@Test (expected = NoExiste.class)
	public void buscarEvento() throws NoExiste{
		Club actual = new Club("Moron");
		actual.buscarEventos(null);
